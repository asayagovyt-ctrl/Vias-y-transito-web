  ...
  return (
    <section id="nosotros" className="relative px-6 py-20 sm:px-10 sm:py-28">
      ...
      >
        ...
        <div className="relative flex min-h-[340px] items-center justify-center rounded-2xl border border-slate-100 bg-white p-10 shadow-lg sm:p-12">
      ...
      <div className="relative mx-auto mt-12 max-w-6xl">
        ...
        <div className="relative h-[420px] overflow-hidden rounded-2xl border border-slate-100 shadow-lg sm:h-[520px]">
          <iframe
